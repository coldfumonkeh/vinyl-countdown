<template>
  <div>
    <header class="border-bottom bg-white mb-4">
      <div
        class="container py-3 d-flex flex-wrap align-items-center justify-content-between gap-2"
      >
        <div>
          <router-link to="/" class="text-decoration-none text-dark">
            <h1 class="h4 mb-0">The Vinyl Countdown</h1>
          </router-link>
          <p v-if="syncedAt" class="text-muted small mb-0">
        ...
        <div class="d-flex gap-3">
          ...
          <a
            href="https://www.discogs.com/user/coldfumonkeh/collection"
            target="_blank"
